...
class CalculadoraMaritima extends Component
{
    ...
    public function buscarTarifasFCL()
    {
        ...
        $this->fclRates = [
            ...
            [
                'validUntil' => '25/11/2022',
                'shippingLine' => 'COSCO',
                'price' => ['gp20' => '3,575', 'gp40' => '5,075', 'hq40' => 'N/A'],
                'closing' => '1',
                'transitTime' => '43',
            ],
            [
                'validUntil' => '22/11/2022',
                'shippingLine' => 'ONE FAK',
                'price' => ['gp20' => '2,225', 'gp40' => '3,375', 'hq40' => '4,775'],
                'closing' => '3',
                'transitTime' => '40',
            ],
            [
                'validUntil' => '30/11/2022',
                'shippingLine' => 'MAERKS',
                'price' => ['gp20' => '3,361', 'gp40' => '3,646', 'hq40' => 'N/A'],
                'closing' => '2',
                'transitTime' => '46',
            ],
            [
                'validUntil' => '30/11/2022',
                'shippingLine' => 'HAPAG LLOYD SPOT',
                'price' => ['gp20' => '3,144', 'gp40' => '4,264', 'hq40' => '2,744'],
                'closing' => '2',
                'transitTime' => '40',
            ],
            [
                'validUntil' => '18/12/2022',
                'shippingLine' => 'CMA CGM',
                'price' => ['gp20' => '2,890', 'gp40' => '4,150', 'hq40' => '4,350'],
                'closing' => '3',
                'transitTime' => '38',
            ],
            [
                'validUntil' => '22/12/2022',
                'shippingLine' => 'EVERGREEN',
                'price' => ['gp20' => '3,250', 'gp40' => '4,820', 'hq40' => '5,120'],
                'closing' => '4',
                'transitTime' => '42',
            ],
            [
                'validUntil' => '05/01/2023',
                'shippingLine' => 'YANG MING',
                'price' => ['gp20' => '2,980', 'gp40' => '4,390', 'hq40' => '4,590'],
                'closing' => '2',
                'transitTime' => '39',
            ],
            [
                'validUntil' => '10/01/2023',
                'shippingLine' => 'ZIM',
                'price' => ['gp20' => '3,120', 'gp40' => '4,680', 'hq40' => 'N/A'],
                'closing' => '3',
                'transitTime' => '44',
            ],
            [
                'validUntil' => '15/01/2023',
                'shippingLine' => 'HYUNDAI',
                'price' => ['gp20' => '2,755', 'gp40' => '3,950', 'hq40' => '4,150'],
                'closing' => '2',
                'transitTime' => '37',
            ],
            [
                'validUntil' => '20/01/2023',
                'shippingLine' => 'PIL PACIFIC',
                'price' => ['gp20' => '2,450', 'gp40' => '3,680', 'hq40' => '3,880'],
                'closing' => '1',
                'transitTime' => '35',
            ],
            [
                'validUntil' => '25/01/2023',
                'shippingLine' => 'OOCL',
                'price' => ['gp20' => '3,480', 'gp40' => '5,120', 'hq40' => '5,420'],
                'closing' => '4',
                'transitTime' => '45',
            ],
            [
                'validUntil' => '28/01/2023',
                'shippingLine' => 'K LINE',
                'price' => ['gp20' => '2,890', 'gp40' => '4,280', 'hq40' => 'N/A'],
                'closing' => '2',
                'transitTime' => '41',
            ],
            [
                'validUntil' => '02/02/2023',
                'shippingLine' => 'MOL',
                'price' => ['gp20' => '3,050', 'gp40' => '4,590', 'hq40' => '4,790'],
                'closing' => '3',
                'transitTime' => '43',
            ],
            [
                'validUntil' => '08/02/2023',
                'shippingLine' => 'APL',
                'price' => ['gp20' => '2,720', 'gp40' => '4,050', 'hq40' => '4,250'],
                'closing' => '2',
                'transitTime' => '36',
            ],
        ];
