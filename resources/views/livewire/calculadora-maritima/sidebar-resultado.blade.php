{{-- 
    ============================================================
    COMPONENTE: Sidebar Resultado Marítimo
    ============================================================
    
    DESCRIPCIÓN:
    Panel lateral para mostrar resultados de cotización marítima.
    Incluye: resultado total, desglose, botón PDF (solo LCL),
    pregunta interactiva y CTA de WhatsApp.
    Solo se muestra para LCL y ULD (FCL tiene su propia tabla).
    
    VARIABLES LIVEWIRE REQUERIDAS:
    - $tipoCarga: string - Tipo de carga actual
    ...
    - descargarPDF(): Genera y descarga PDF (solo LCL)
