{{-- 
    ...
    - $editandoProductoIndex: int|null - Producto actualmente editando
...
<div class="bg-white/5 backdrop-blur-xl border border-yellow-500/20 rounded-2xl p-6 shadow-xl">
    {{-- Título del formulario con indicador de producto --}}
    <h3 class="text-yellow-500 font-bold mb-2 text-lg uppercase tracking-widest flex items-center">
    ...
    @if($editandoProductoIndex !== null && isset($carrito[$editandoProductoIndex]))
        <div class="mb-4 p-3 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/30 rounded-xl">
            <p class="text-sm text-blue-400 flex items-center">
                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                </svg>
                Editando: <span class="font-bold ml-1 text-yellow-400">{{ $carrito[$editandoProductoIndex]['codigo_hs'] }}</span>
                <span class="mx-2 text-gray-500">-</span>
                <span class="text-gray-300 truncate">{{ Str::limit($carrito[$editandoProductoIndex]['descripcion'], 40) }}</span>
            </p>
        </div>
    @else
        <p class="text-gray-400 text-sm mb-4">Selecciona un producto de la lista para editar sus valores</p>
    @endif
